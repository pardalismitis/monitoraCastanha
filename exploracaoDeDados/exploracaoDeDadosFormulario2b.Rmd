...
dados <- dados %>%
  ...
  relocate(Nome_Castanhal, .after = Ano)
  ...
  dplyr::mutate(
    UC = case_when(
      ...
      UC == "JAÚ" ~ "PARNA do Jaú",
      UC == "UAT" ~ "REBIO Uatumã",
      UC == "Resex do Rio Unini" ~ "RESEX do Rio Unini",
      UC == "Resex  do Rio Unini" ~ "RESEX do Rio Unini",
      UC == "Rebio Trombetas" ~"REBIO do Rio Trombetas",
      UC == "Resex Médio Juruá e RDS Uacari" ~ "RESEX Médio Juruá e RDS Uacari",
      TRUE ~ UC)
    )
